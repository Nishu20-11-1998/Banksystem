                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                    <label> <font color="red">${insertFailed} </font> </label> <br>
								<%
								...
								%>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" id="inputEmailAddress" type="number" maxlength="10" minlength="10" name="mobile" aria-describedby="emailHelp" placeholder="Enter Mobile address" />
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <input type="submit" onclick="return Validate()"  class="btn btn-primary btn-block" value="Create Account"></div>
                                    </form>
                                    </div>
